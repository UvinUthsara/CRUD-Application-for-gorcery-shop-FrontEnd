...
const EditPage = () => {
  ...
  const [product,setProduct] = useState ({
        name: "" ,  
        quantity: "" ,     //default values should be empty
        price: "" , 
        image: "" ,
   ...
   const getproduct = async() =>{
       setIsLoading(true);
        try{
          const response = await axios.get(`https://cookfood.onrender.com/api/products/${id}`);
          setProduct({
   ...
   const updateProduct = async(e) =>{
      ...
      try{
          ...
          navigate('/') //redirect to homepage after updating sucessfully
